...
dumpjson("ex_FComp", [data, best, res]) # hide
show((best, res)) # hide
```
...
data = Measures(dom, [4.01, 7.58, 12.13, 19.78, 29.04], 0.4)
best, res = fit(model, data)
dumpjson("ex_FComp2", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_FComp3", [data, best, res]) # hide
show((best, res)) # hide
```
...
println("b:  ", best[:linear].b.val    , " ± ", best[:linear].b.unc)
println("m:  ", best[:linear].m.val    , " ± ", best[:linear].m.unc)
println("p2: ", best[:quadratic].p2.val, " ± ", best[:quadratic].p2.unc)
```
...
data = Measures(dom, [4.01, 7.58, 12.13, 19.78, 29.04], 0.4)
best, res = fit(model, data)
dumpjson("ex_OffsetSlope", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_OffsetSlope2d", [data, best, res]) # hide
show((best, res)) # hide
```
...
data = Measures(dom, [4.01, 7.58, 12.13, 19.78, 29.04], 0.4)
best, res = fit(model, data)
dumpjson("ex_Polynomial", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_Polynomial2", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_Gaussian", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_Gaussian2", [data, best, res]) # hide
show((best, res)) # hide
```
...
best, res = fit(model, data)
dumpjson("ex_Gaussian2D", [data, best, res]) # hide
show((best, res)) # hide
```
...
data = Measures(dom, [4.01, 7.58, 12.13, 19.78, 29.04], 0.4)
best, res = fit(model, data)
dumpjson("ex_SumReducer", [data, best, res]) # hide
show((best, res)) # hide
```
